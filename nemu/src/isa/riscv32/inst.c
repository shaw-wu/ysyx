...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT_START();
	...
	INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli	 , I, R(rd) = src1 << (imm & 0x03f));
	INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl 	 , R, R(rd) = src1 >> src2);
	INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli	 , I, R(rd) = src1 >> (imm & 0x03f));
	INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra	   , R, R(rd) = (int32_t)src1 >> src2);
	INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai	 , I, R(rd) = (int32_t)src1 >> (imm & 0x03f));
