...
#define SERIAL_END (SERIAL_ADDR + SERIAL_SIZE)
#define TIMER_END (TIMER_ADDR + TIMER_SIZE)

#define PMEM_LEFT  ((paddr_t)CONFIG_MBASE)
#define PMEM_RIGHT ((paddr_t)CONFIG_MBASE + CONFIG_MSIZE - 1)
#define RESET_VECTOR (PMEM_LEFT + CONFIG_PC_RESET_OFFSET)/* CONFIG_PC_RESET_OFFSET = 0 wxz*/
